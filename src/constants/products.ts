...
export const PRODUCTS: Product[] = [
  ...
  // SUPLEMEN
  {
    id: "bariklanavirgincoconutoil",
    name: "BARIKLANA VIRGIN COCONUT OIL",
    slug: "bariklana-virgin-coconut-oil",
    price: 38000,
    category: "Suplemen",
  ...
  {
    id: "bariklanadeodorantspray",
    name: "BARIKLANA DEODORANT SPRAY",
    slug: "bariklana-deodorant-spray",
    price: 33000,
    category: "Bodycare",
  ...
  {
    id: "bariklanamagnesium",
    name: "BARIKLANA MAGNESIUM",
    slug: "bariklana-magnesium",
    price: 83000,
    category: "Bodycare",
